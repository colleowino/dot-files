" Tomorrow Moon - Full Colour 
" http://colleowino.github.io
"
" Hex colour conversion functions borrowed from the theme "Tomorrow-Night""
...
let s:builtin  = "F69385"  " bright red 
let s:string   = "F1BF8E"		"	light orange
let s:proper   = "99CBCA"		" blue
let s:bool     = "B3EFE5"		"	bright blue 
let s:func     = "B0D89C"		"	light green
let s:punct    = "F277A1"		" pink
let s:keyword  = "BB84B4"		"	purple 
let s:comment  = "929292"		" dark grey
let s:number   = "9D8FF2"		"	light purple 
...
let g:colors_name = "Tomorrow-Moon"
